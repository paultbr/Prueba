...
<!-- 
en el codigo se obtiene con el metodo hasOne los usuarios que es de ayuda para obtener en el metodo "show" 
de PostController las publicaicones realizas  de acuerdo al id del usario 
 -->
...
~~~
<!-- 
    El codigo si valida que el usuario exista pero al recuperar la informacion solo se obtendria los registros con el campo Tittle_Post, 
    ademas que no se esta validando el numero minimo de registros, nos obtendran todos lo registro que se tenga
 -->
...
~~~
<!-- 
    Primero se necesita crear el servicio que nos permita obtener la informacion que se desea porque solo se tiene la respuesta mas 
    no la conexion, luego se crea un metodolo el cual permita exportar dicha informacion en un archivo, esto con la ayuda de alguna 
    libreria para generar archivos o un metodo propio creado -->
